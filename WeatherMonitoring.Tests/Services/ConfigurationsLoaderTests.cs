...
{
    [Theory]
    [ObjectTypeData(typeof(ConfigTestCaseRow), "Services", "ConfigurationsLoader", "config-test-data.csv")]
    ...
    [Theory]
    [ObjectTypeData(typeof(InputTestCaseRow), "Services", "ConfigurationsLoader", "missing-file-test-data.csv")]
