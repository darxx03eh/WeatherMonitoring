...
public sealed class ParserFactoryTests
{
    ...
    [Theory]
    [CsvData(typeof(InputTestCaseRow), "TestData", "Parsers", "ParserFactory", "invalid-input-test-data.csv")]
    ...
    [Theory]
    [CsvData(typeof(InputTestCaseRow), "TestData", "Parsers", "ParserFactory", "valid-json-test-data.csv")]
    ...
    [Theory]
    [CsvData(typeof(InputTestCaseRow),  "TestData", "Parsers", "ParserFactory", "valid-xml-test-data.csv")]
